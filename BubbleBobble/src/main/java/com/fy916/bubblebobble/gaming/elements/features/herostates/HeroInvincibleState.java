...
/**
 * An Interface which offers the Invincible state method framework for {@link Hero}.<br/>
 * This shows the STATE and TEMPLATE Design Pattern. 
 * @author fy916
 * @version 1.0
 */
public interface HeroInvincibleState {

    /**
     * Abstract Method which updates the state of the {@link Hero} when in invincible state or not.
     * @author fy916
     */
